  ...
  return (
    <div className="m-6 bg-white px-20 py-16 rounded-2xl shadow-2xl">
      ...
      <a
        href={url_preview}
        target="_blank"
        className="bg-indigo-600 mr-2 hover:bg-indigo-800 hover:shadow-lg text-white px-6 py-2 rounded-full"
      >
        Vista Previa
      </a>
      <br />
      ...
      <a
        href={url_github}
        target="_blank"
        className="bg-indigo-600 hover:bg-indigo-800 hover:shadow-lg text-white px-6 py-2 rounded-full"
      >
        GitHub
      </a>
    </div>
